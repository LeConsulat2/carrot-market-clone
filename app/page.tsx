export default function Home() {
  return (
    <main className="bg-gray-300  sm:bg-red-200 md:bg-green-200 lg:bg-cyan-300 xl:bg-slate-950 h-screen flex items-center justify-center p-5 ">
      <div className="bg-white w-full flex flex-col flex-1 md:flex-row gap-2 shadow-lg  rounded-2xl max-w-screen-sm p-5 dark:bg-white">
        <div className="flex flex-col flex-1 *:outline-none">
          ...
          />
          <span className="h-6 text-red-500 font-medium hidden peer-invalid:block">
            Email is required
          </span>
        </div>
